<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
	...
	<td>
		<input id="join-id" name="join-id" style="margin-right: 88px" type="text" />
		<button id="check-dupl-btn" name="check_dupl_btn">중복확인</button>
	</td>
	</tr>
	
	<tr>
	<td>암호</td>
	<td><input id="pass" name="pass"   style="margin-right: 150px" type="password" /></td>
	</tr>
	
	<tr>
	<td>이름</td>
	<td><input id="name" name="name"  style="margin-right: 150px"  type="text" /></td>
	</tr>
	...
	<tr>
		<td colspan="2" style="text-align: center;">
			<button id="btn-join-confirm" style="width: 160px; height: 30px">확 인</button> 
			<button style="width: 160px; height: 30px">취 소</button>
		</td>
	</tr>
	</table>S
<script>
		$('#btn-join-confirm').on('click', function(){
		  alert("클릭 인식됨.");
		  var id = $('#join-id').val();
		  var pass = $('#pass').val();
		  var name = $('#name').val();
